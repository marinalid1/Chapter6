...
// Pg 267, create controller method generates a new enrollment object to be saved into the database from the course refrence, user refrence, and the lessons array
 ...
 */
// Pg 270, query the ENrollment collection by the provided ID, and if a matching enrollment document is found, we ensure the refrenced course, the nested course instructor and the refrenced student details are populated
...
// Pg 271, read component
const read = (req, res) => {
  return res.json(req.enrollment)
}

// Pg 276, complete course
...
// Pg 271, check wether the currently signed-in user is the student who is associated with this specific enrollemnt in the isStudent method
...
// Pg 280, query the database and return the results in the response to the client
...
// Pg 266, findEnrollment controller methos will query the Enrollment collection database in order to check wether there is already an enrollment with the given course Id and user ID.
...
// Pg 283, displays the enrollment stats
