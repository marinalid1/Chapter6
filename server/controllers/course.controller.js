...
// Pg 235, Invokes the read controller method
const read = (req, res) => {
...
// Pg 240, check if the cirremt user is an instructor
...
// Pg 231, listByInstructor controller method will query the course collection in the database in order to get the matching courses
...
// Pg 261, initiates a query to the Course collection for courses that have the published attribute's set to true
