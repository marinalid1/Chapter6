...
// Pg 261, the published courses API
router.route('/api/courses/published')
  .get(courseCtrl.listPublished)

// Pg 224, the create course API
// Pg 230, The list course API
...
router.route('/api/courses/:courseId')
  ...
  // Pg 231, user is available in the request object as profile
