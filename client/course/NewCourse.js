...
// Pg 227, the NewCourse component
export default function NewCourse() {
  ...
  // Pg 228, define a handler function in NewCourse so that we can track changes to these fields in the form view
  ...
  //Pg 227, <input accept="image/*" onChange={handleChange('image')} className={classes.input} id="icon-button-file" type="file" />
  // Pg 228, add name, description and category from the fields using the textfield component
    if (values.redirect) {
