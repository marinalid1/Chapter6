...
export default function EditCourse ({match}) {
  ...
  const [values, setValues] = useState({
    ...
    // Pg 249, the EditCourse component
    useEffect(() => {
  ...
  // Pg 250, changes in the input method will be handled in order to capture the newly entered values with the handleCHange method
  ...
  // Pg 253, handle the changes made to the values in each field
  ...
  // Pg 254, when the delete button is clicked, the indec of the lesson is being deleted and removed from the lesson array
 ...
 // Pg 254, when the user clicks this button, the lesson in the current index will be moved up
  ...
  // Pg 251, clickSubmut function that is called on saving
  const clickSubmit = () => {
  ...
  if (values.redirect) {
   ...
   // Pg 249, option to upload a new image and a save button
   // Pg 252, Editing lesson details
   // Pg 253, moving the lessons to rerrange the order
   // Pg 254, deleting a lesson
          return (
